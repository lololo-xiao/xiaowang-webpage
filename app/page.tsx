...
export default function Page() {
  return (
    <>
      ...
      {/* ── hero / vertical nav ── */}
      <section id="hero" className="min-h-screen flex flex-col items-center justify-center gap-0 px-4">
        ...
        <nav className="flex flex-col items-center gap-14">
          ...
          <a href="#projects" className="nav-item flex flex-col items-center gap-3">
            <svg className="ink-icon" width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M22 8 L22 22" stroke="#111" strokeWidth="1" strokeLinecap="round" />
        ...
        <div className="max-w-md section-content text-center">
          ...
          <div className="mt-16 opacity-20">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="mx-auto">
              <line x1="0" y1="10" x2="20" y2="10" stroke="#111" strokeWidth="0.8" />
              <line x1="10" y1="0" x2="10" y2="20" stroke="#111" strokeWidth="0.8" />
            </svg>
          </div>
        </div>
      </section>
      ...
      {/* ── writing section ── */}
      <section id="writing" className="min-h-screen flex items-center justify-center px-6">
        <div className="max-w-md section-content text-center">
          <svg className="mx-auto mb-8 opacity-40" width="28" height="28" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M22 36 L12 16 L22 10 L32 16 Z" stroke="#111" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M22 36 L22 22" stroke="#111" strokeWidth="1" strokeLinecap="round" />
          ...
          <h2 className="text-2xl mb-8 tracking-wide">writing</h2>

          <ul className="mt-2 w-full text-sm">
            {posts.map((post) => (
              <li key={post.slug}>
                <Link
                  href={`/writing/${post.slug}`}
                  className="nav-item flex justify-between items-baseline gap-8 py-3 border-b border-black/10 last:border-b-0"
                >
                  <span className="tracking-wide">{post.title}</span>
                  <span className="text-xs tracking-widest opacity-40 shrink-0">{post.date}</span>
                </Link>
              </li>
            ))}
          </ul>
